					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>E</span>-Hằng Borsch</h1>
									<h2>SHOP CHUYÊN HÀNG NHẬP KHẨU</h2>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								...
								@foreach($brand as $key => $brand)
									<li><a href="{{URL::to('/thuong-hieu-san-pham/'.$brand->brand_id)}}"> <span class="pull-right">(50)</span> {{$brand->brand_desc}}</a></li>
								@endforeach
								</ul>
							</div>
						</div><!--/brands_products-->
